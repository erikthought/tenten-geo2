      ...
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-sm border-b border-gray-200 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="https://tenten.co/about" className="text-gray-600 hover:text-blue-600 transition-colors">À propos</Link>
          </nav>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="text-gray-600">Augmentation moyenne du trafic</div>
            </motion.div>
            <motion.div
              className="text-center"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <div className="text-gray-600">Amélioration de la génération de leads</div>
            </motion.div>
            <motion.div
              className="text-center"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <div className="text-gray-600">Croissance des revenus</div>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="https://tenten.co/about" className="text-gray-400 hover:text-white transition-colors">À propos</Link></li>
                <li><Link href="https://tenten.co/learning/" className="text-gray-400 hover:text-white transition-colors">Blog</Link></li>
                <li><Link href="https://tenten.co/portfolio" className="text-gray-400 hover:text-white transition-colors">Études de cas</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="https://go.tenten.co/map" className="text-gray-400 hover:text-white transition-colors">Siège - Taipei</Link></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2024 Tenten Co. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </main>
