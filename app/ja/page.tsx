      ...
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-sm border-b border-gray-200 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#testimonials" className="text-gray-600 hover:text-blue-600 transition-colors">ケーススタディ</Link>
            <Link href="https://tenten.co/about" className="text-gray-600 hover:text-blue-600 transition-colors">会社概要</Link>
          </nav>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="text-gray-600">平均トラフィック増加</div>
            </motion.div>
            <motion.div
              className="text-center"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <div className="text-gray-600">リード生成向上</div>
            </motion.div>
            <motion.div
              className="text-center"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <div className="text-gray-600">収益成長</div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4">つながる</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="https://tenten.co/about" className="text-gray-400 hover:text-white transition-colors">会社概要</Link></li>
                <li><Link href="https://tenten.co/learning/" className="text-gray-400 hover:text-white transition-colors">ブログ</Link></li>
                <li><Link href="https://tenten.co/portfolio" className="text-gray-400 hover:text-white transition-colors">ケーススタディ</Link></li>
                <li><Link href="https://tenten.co/contact" className="text-gray-400 hover:text-white transition-colors">連絡先</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="https://go.tenten.co/map" className="text-gray-400 hover:text-white transition-colors">本社 - 台北</Link></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2024 Tenten Co. 全著作権所有。</p>
          </div>
        </div>
      </footer>
    </main>
